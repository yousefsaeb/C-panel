...
<?php
            ...
            <label for="myCheckbox">Administration:<input type="checkbox" id="myCheckbox" name="isadmin"
                    style="min-height:0"></label>

           
            <button type="submit" class="submit-add-button" name="submit">Submit</button>
